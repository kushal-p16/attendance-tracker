...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="page-wrap">
      <section className="welcome-row"><div><p className="eyebrow">SATURDAY, 12 SEPTEMBER 2026</p><h1>Good morning, Alex<span className="accent-dot">.</span></h1><p className="lede">Keep your attendance in the safe zone before the next IA.</p></div><button className="primary-btn" onClick={() => { setEditing(null); setModal('subject') }}><Plus size={18} /> Add subject</button></section>
